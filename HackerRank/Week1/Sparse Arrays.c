...
int* matchstr(int strings_count, char** strings, int queries_count, char** queries, int* result_count) {
...
int main()
{
    ...
    int res_count;
    int* res = matchstr(strings_count, strings, queries_count, queries, &res_count);
